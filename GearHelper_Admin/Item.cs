...
namespace GearHelper_Admin
{
    internal class Item
    {
        ...
        public override string ToString()
        {
            ...
            return String.Format("{0,-2} {1,-25} {2,-3} {3,-3} {4,-3} {5,-3} {6,-3} {7,-3} {8,-8} {9}", this.id, this.name, this.stat1, this.stat1amount, this.stat2, this.stat2amount, this.stat3, this.stat3amount, this.slot, materialName);
        }
    }
}
